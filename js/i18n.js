...
es:{
  ...
  "weather.sunrise":"sale el sol a las {time}", "weather.sunset":"el sol se pone a las {time}", "weather.sunriseTomorrow":"mañana sale el sol a las {time}",
  "weather.range":"máx. {max}° · mín. {min}°", "weather.rain":"{p} % de lluvia", "weather.here":"Aquí",
  ...
  "s.backHome":"← Inicio", "s.logout":"Cerrar sesión",
...
en:{
  ...
  "weather.sunrise":"sunrise at {time}", "weather.sunset":"sunset at {time}", "weather.sunriseTomorrow":"sunrise tomorrow at {time}",
  "weather.range":"high {max}° · low {min}°", "weather.rain":"{p} % chance of rain", "weather.here":"Here",
  ...
  "s.backHome":"← Home", "s.logout":"Log out",
