...
const SUBJ={
 ed :{n:"Estructura de Datos",ab:"ED",       c:"#D01F63",s:"#FCE7EF",ects:6,dept:"Informática",grp:"1081",cam:"LEG",ag:["Sin código en el kickoff"]},
 talf:{n:"Tª Autómatas y Leng. Formales",ab:"TALF",c:"#BE7000",s:"#FBEEDA",ects:6,dept:"Informática",grp:"82",cam:"LEG",ag:["C2.218.13877-82"]},
 is :{n:"Ingeniería del Software",ab:"IS",   c:"#1E6FC4",s:"#E4EFFA",ects:6,dept:"Informática",grp:"82",cam:"LEG",ag:["C2.218.15974-82"]},
 ec :{n:"Estructura de Computadores",ab:"EC",c:"#0F7A63",s:"#DFF1EC",ects:6,dept:"Informática",grp:"82",cam:"LEG",ag:["C2.218.13874-82"]},
 eco:{n:"Principios de Economía",ab:"ECO",    c:"#6B3FC8",s:"#EDE6FA",ects:6,dept:"Economía",grp:"801",cam:"GET",ag:["M1.204.13151-75 (magistral)","C2.233.13151-801 (prácticas)"]},
 dcp:{n:"Int. Dcho. Civil Patrimonial",ab:"DCP",c:"#A02E8F",s:"#F8E5F4",ects:6,dept:"Derecho Privado",grp:"801",cam:"GET",ag:["M1.204.13150-75 (magistral)","C2.233.13150-801 (prácticas)"]},
 est:{n:"Estadística II",ab:"EST",            c:"#3F51A8",s:"#E6E9F7",ects:6,dept:"Estadística",grp:"801",cam:"GET",ag:["M1.204.13160-77 (magistral)","C2.233.13160-801 (prácticas)"]}
};

const CLASSES=[
 {id:"est", d:0,a:540,b:630, t:"prácticas",  au:"Aula 5.1.04",  r:"7 sep – 30 nov",grp:"801"},
 {id:"dcp", d:0,a:645,b:735, t:"magistral",  au:"Aula 10.2.1",  r:"7 sep – 30 nov",grp:"76 y 801"},
 {id:"eco", d:0,a:750,b:840, t:"magistral",  au:"Aula 10.2.1",  r:"7 sep – 30 nov",grp:"27, 76 y 801",half:0,dash:1,mark:"⚠"},
 {id:"ed",  d:0,a:750,b:840, t:"prácticas",  au:"Aulas varias", r:"5 y 19 oct · 16 y 30 nov",grp:"1081",half:1,dash:1,hatch:1,mark:"⚠"},
 {id:"talf",d:1,a:540,b:630, t:"teoría",     au:"Aula 2.3.B05", r:"8 sep – 1 dic",grp:"82"},
 {id:"is",  d:1,a:645,b:735, t:"teoría",     au:"Aula 4.0.E04", r:"8 sep – 1 dic",grp:"82"},
 {id:"est", d:2,a:540,b:630, t:"magistral",  au:"Aula 10.2.1",  r:"9 sep – 9 dic",grp:"78 y 801"},
 {id:"eco", d:2,a:645,b:735, t:"prácticas",  au:"Aula 10.1.6",  r:"9 sep – 9 dic",grp:"801"},
 {id:"dcp", d:2,a:750,b:840, t:"prácticas",  au:"Aula 6.1.02",  r:"9 sep – 9 dic",grp:"801"},
 {id:"ec",  d:2,a:930,b:1020,t:"teoría",     au:"Aula 2.3.A01", r:"9 sep – 9 dic",grp:"82"},
 {id:"ed",  d:3,a:540,b:630, t:"teoría",     au:"Aula 2.3.C01", r:"10 sep – 10 dic",grp:"1081"},
 {id:"is",  d:3,a:645,b:735, t:"teoría",     au:"Aula 2.3.D01", r:"10 sep – 10 dic",grp:"82"},
 {id:"talf",d:3,a:930,b:1020,t:"prácticas",  au:"1.0.F03 · INF 7.0.J02",r:"24 sep · 5 nov · 10 dic",grp:"82",hatch:1},
 {id:"ec",  d:3,a:1035,b:1125,t:"teoría",    au:"Aula 2.3.D03", r:"10 sep – 10 dic",grp:"82"},
 {id:"ed",  d:4,a:540,b:630, t:"teoría",     au:"Aula INF 2.2.C.04 DUAL",r:"11 sep – 11 dic",grp:"1081"},
 {id:"talf",d:4,a:645,b:735, t:"teoría",     au:"Aula 2.3.C03", r:"11 sep – 11 dic",grp:"82"},
 {id:"talf",d:4,a:750,b:840, t:"prácticas",  au:"Aula 4.0.E04", r:"solo 13 nov",grp:"82",hatch:1},
 {id:"is",  d:4,a:1035,b:1125,t:"prácticas", au:"Aula 4.1.E06", r:"2, 16 y 30 oct · 20 nov",grp:"82",hatch:1}
];
...
const PROFS=[
 ...
 {id:"ed",name:"Isabel Segura Bedmar",rol:"teoria",coord:false,mail:"isegura@inf.uc3m.es",office:"",
  note:"Es quien da las clases del 1081, jueves y viernes."},
 ...
 {id:"eco",name:"Ángel Hernando Veciana",rol:"",coord:true,mail:"angel.hernando@uc3m.es",office:"15.1.63 · López Aranguren, Getafe",
  note:"Coordina magistral y prácticas, pero no da ninguna de las dos. Para dudas del día a día, ve primero a tu profesor de aula."},
 {id:"dcp",name:"Sergio Del Bosque Gómez",rol:"magistral+practicas",coord:false,mail:"sdelbosq@der-pr.uc3m.es",office:"",
  note:"Da las dos: la magistral de los lunes y las prácticas de los miércoles."},
 {id:"dcp",name:"Yolanda Bergel Sainz de Baranda",rol:"",coord:true,mail:"ybergel@der-pr.uc3m.es",office:"15.2.77 · López Aranguren, Getafe",
  note:"Coordina magistral y prácticas, pero no da ninguna de las dos."},
 {id:"est",name:"Regina Kaiser Remiro",rol:"magistral",coord:true,mail:"kaiser@est-econ.uc3m.es",office:"",
  note:"Da la magistral de los miércoles y coordina el curso de prácticas."},
 ...
 {id:"est",name:"Sandra Benítez Peña",rol:"",coord:true,mail:"sbenitez@est-econ.uc3m.es",office:"",
  note:"Coordina el curso de magistral."}
];
...
const CAL=[
 ...
 {id:"talf",date:"2026-10-02",wk:"S4", label:"vie 2 oct",   what:"JFLAP 1 (autómatas finitos, temas 2 y 3). Obligatorio, en parejas",w:"obligatorio",type:"en"},
 ...
 {id:"eco", date:"2026-10-07",wk:"S5", label:"mié 7 oct",   what:"Evaluación en clase 1, grupo reducido. Papel y bolígrafo, sin retrasos",w:"12 % final",type:"ex"},
 {id:"is",  date:"2026-10-09",wk:"S5", label:"5–9 oct",     what:"Examen parcial I de teoría",w:"15 %",type:"ex"},
 {id:"ed",  date:"2026-10-15",wk:"S6", label:"jue 15 oct",  what:"Primer parcial: bloque 1, ítems 1 a 5. Presencial y escrito, aula 2.3.C01",w:"25 %",type:"ex"},
 ...
 {id:"eco", date:"2026-10-26",wk:"S8", label:"26–31 oct",   what:"Test online 1 en Aula Global. Abre lunes 9:00, cierra sábado 14:00",w:"8 % final",type:"ex"},
 {id:"dcp", date:"2026-10-28",wk:"S8", label:"mié 28 oct",  what:"Cuestionario de autoevaluación tipo test",w:"1 pto / 10",type:"ex"},
 ...
 {id:"talf",date:"2026-11-05",wk:"S9", label:"jue 5 nov",   what:"JFLAP 2 (gramáticas, tema 4), INF 7.0.J02, 15:30",w:"obligatorio",type:"en"},
 {id:"ec",  date:"2026-11-05",wk:"S9", label:"jue 5 nov",   what:"Examen parcial, 17:15",w:"parte del 30 %",type:"ex"},
 {id:"talf",date:"2026-11-06",wk:"S9", label:"vie 6 nov",   what:"EC1: temas 2, 3 y 4 más JFLAP 1",w:"25 % aprox.",type:"ex"},
 {id:"ed",  date:"2026-11-13",wk:"S10",label:"vie 13 nov",  what:"Segundo parcial: bloque 2, ítem 6. Presencial y escrito, aula 2.2.C04",w:"25 %",type:"ex"},
 ...
 {id:"eco", date:"2026-11-18",wk:"S11",label:"mié 18 nov",  what:"Evaluación en clase 2",w:"12 % final",type:"ex"},
 ...
 {id:"talf",date:"2026-11-27",wk:"S12",label:"vie 27 nov",  what:"JFLAP 3 (autómatas a pila, tema 6). Horario sin cerrar: 10:45 o 19–21 h",w:"obligatorio",type:"en"},
 ...
 {id:"eco", date:"2026-12-07",wk:"S14",label:"7–12 dic",    what:"Test online 2 en Aula Global",w:"8 % final",type:"ex"},
 {id:"dcp", date:"2026-12-09",wk:"S14",label:"mié 9 dic",   what:"Caso práctico final de recapitulación, en clase",w:"2 ptos / 10",type:"ex"},
 {id:"talf",date:"2026-12-10",wk:"S14",label:"jue 10 dic",  what:"JFLAP 4 (máquinas de Turing), INF 7.0.J02, 15:30",w:"obligatorio",type:"en"},
 {id:"is",  date:"2026-12-11",wk:"S14",label:"7–11 dic",    what:"Entrega del trabajo individual, parte práctica",w:"20 %",type:"en"},
 {id:"talf",date:"2026-12-11",wk:"S14",label:"vie 11 dic",  what:"EC2: temas 5, 6 y 7 más JFLAP 2, 3 y 4",w:"25 % aprox.",type:"ex"}
];
