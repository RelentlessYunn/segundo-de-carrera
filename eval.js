...
est:{
 ...
 bar:[["Parcial 1",17.5],["Parcial 2",17.5],["Clase",5],["Examen final",60]],
 min:"<b>Un 4 sobre 10 en el examen final.</b> Sin esa nota no se aprueba, por mucho que sumen los parciales.",
 rules:[
 ...
 weeks:[["Tema 1","Inferencia sobre una población: estimadores puntuales, estimación de media y varianza, distribución de la media en el muestreo e intervalos de confianza (varianza conocida y desconocida, muestras grandes, t de Student, varianza)"],
        ...
        ["Tema 4","Regresión lineal simple: especificación del modelo, mínimos cuadrados, inferencia sobre pendiente y varianza, estimación de la respuesta promedio y predicción"],
        ["Tema 5","Diagnóstico y regresión múltiple: análisis de residuos, descomposición ADEVA, transformaciones para linealizar, forma matricial e introducción a la regresión múltiple"]]}
};